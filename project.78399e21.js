...
function (_React$Component) {
  ...
  function MemoryGame(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MemoryGame).call(this, props));
    _this.state = {
      suits: ['0001', '0002', '0003', '0004', '0005', '0006', '0007', '0008', '0009', '0010', '0011', '0012', '0001', '0002', '0003', '0004', '0005', '0006', '0007', '0008', '0009', '0010', '0011', '0012']
    };
    _this.cardawesfzs = _this.cardawesfzs.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  } // randomise(){
  //   const random = this.state.suits.map((suits)=> {Math.random() - 0.5;});
  // }


  _createClass(MemoryGame, [{
    key: "cardawesfzs",
    value: function cardawesfzs(suits) {
      // this.suits = suits;
      console.log(suits);
      var newSuits = newSuits.map(function (suits) {
        Math.random() - 0.5;
      });
      console.log(newSuits); // newSuits.map(()=>{
      //   <Card>{newSuits}</Card>
      //   console.log(newSuits);
      // })
      // // for (let i=0; i<newSuits.length; i+=1){
      // }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, this.cardawesfzs(this.state.suits), ") }");
    }
  }]);
...
},{}]},{},["C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.jsx"], null)
//# sourceMappingURL=/project.78399e21.map