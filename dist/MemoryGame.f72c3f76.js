...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"MemoryGame.jsx":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function MemoryGame() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MemoryGame).call(this));
    _this.state = {
      suits: ['0001', '0002', '0003', '0004', '0005', '0006', '0007', '0008', '0001', '0002', '0003', '0004', '0005', '0006', '0007', '0008']
    };
    _this.showCard = _this.showCard.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(MemoryGame, [{
    key: "showCard",
    value: function showCard(props) {
      var newSuits = props.suits.sort(function () {
        return .5 - Math.random();
      });
      return newSuits.map(function (suits) {
    ...
    value: function render() {
      ...
      }, _react.default.createElement(this.showCard, {
...
function (_React$Component2) {
  ...
  function Card(props) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Card).call(this, props));
    _this2.state = {
      fliped: false,
      match: false
    };
    _this2.mouseClick = _this2.mouseClick.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
    return _this2;
  }
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      // console.log(<Card/>)
      return _react.default.createElement("div", {
        className: "card " + (this.state.fliped ? 'flip' : ''),
        key: this.props.key,
        ...
        src: "https://raw.githubusercontent.com/Boardonly/project1/master/images/back.jpg"
      })), _react.default.createElement("div", {
        className: "back"
      }, _react.default.createElement("img", {
        src: "https://raw.githubusercontent.com/Boardonly/project1/master/images/" + this.props.suits + ".jpg"
      })));
    }
  }]);
...
_reactDom.default.render(_react.default.createElement(MemoryGame, null), document.getElementById('memory'));
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js"}],"C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","MemoryGame.jsx"], null)
//# sourceMappingURL=/MemoryGame.f72c3f76.map